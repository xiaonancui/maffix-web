...
export default function TaskSubmitButton({ taskId }: { taskId: string }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      alert('Task submitted successfully! Awaiting admin verification.')
      router.refresh()
    } catch (error) {
