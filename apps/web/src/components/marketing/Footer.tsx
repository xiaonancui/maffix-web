...
const footerNavigation = {
  ...
  features: [
    { name: 'Gacha System', href: '/features/gacha' },
    { name: 'Missions', href: '/features/missions' },
    { name: 'Store', href: '/features/store' },
  ...
  social: [
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/maffix',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
